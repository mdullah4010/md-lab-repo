...
# AI Migrate Program — Insights Agent
...
This repository contains the **AI Insights Agent** — a key component of Microsoft's FY26 **AI Migrate Technical Program**. It is one of six AI agents being developed to automate and accelerate each phase of the cloud migration lifecycle.

The AI Insights Agent orchestrates multiple sub-agents automating many of the task involved during the Assessment, Design and Planning phases of a migration program. It takes as input documentation about the application to migrate, its source code and the result of scanning tools such as Azure migrate to generate comprehensive Application Summary Report (ASR), Design Document, and App Migration Plan among other artifacts.   

In traditional migration programs, these activities require significant manual effort from architects, project managers, and technical SMEs. This solution uses AI agents to automate these tasks at scale—allowing organizations to process hundreds of applications in parallel rather than sequentially.

---

## Why was it created?

Microsoft is at a pivotal moment in its cloud modernization journey. **Cloud transformation demands speed, scale, and intelligence.** Traditional, manual migration approaches can no longer meet market expectations.

### The Problem

The current migration tooling landscape is fragmented, resource-intensive, and slow. Microsoft's legacy tools (ACT, ACC, AAP, CTS, ACF) are no longer sufficient to meet the demands of modern cloud transformation. Meanwhile, competitors are deploying AI-powered platforms that compress migration timelines from weeks to minutes.


## Who created it?

Developed by **Microsoft's Industry Solution Delivery (ISD)** as part of the **FY26 AI Migrate Technical Program**. This is an internal accelerator built to support large customer migration engagements.
...
|----------|-------------|----------|
| **[AI Foundry Agents](./foundry-agents/README.md)** | Code-based agents built on Azure AI Foundry + Semantic Kernel | Full customization, API integration |
| **[Copilot Studio Agents](./copilot-agents/README.md)** | No-code agents for Microsoft Teams & M365 Copilot | Quick deployment, business users |
...
### Option 1: AI Foundry Agents (Code-Based)

1. **Deploy Infrastructure**
   - 🧪 [Sandbox](./foundry-agents/docs/INFRA_STANDARD.md) — Development/POC
   - 🏢 [Production](./foundry-agents/docs/INFRA_AI_LZ.md) — Reference Implementation for an AI Landing Zone (CAF & WAF compliant)

2. **Deploy Agents** — Follow the [AI Foundry README](./foundry-agents/README.md)

### Option 2: Copilot Studio Agents (No-Code)

Import the provided `.zip` solutions into Copilot Studio. See [Copilot Agents README](./copilot-agents/README.md).

> **Note:** Copilot Studio agents don't require Azure AI Foundry infrastructure—just import and configure connections.
...
<!-----------------------[  Deployment (CI/CD)  ]-----------<optional> section 
### Deployment (CI/CD)
...
<!---- [TODO]  CONTENT GOES BELOW ------->
**We highly encourage contributions to this repo.**
<!--
