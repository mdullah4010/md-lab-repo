...
Comprehensive reference for all FastAPI routes defined in [api_main.py](api_main.py). All endpoints consume and produce `application/json`. Role-Based Access Control (RBAC) is enforced either via JSON request bodies or HTTP headers depending on the endpoint.

The following diagram depicts the API endpoints and the corresponding agents and plugins.

<img src="./../docs/media/insights-api.jpg" alt="Diagram of Insights API" width="100%">
---
...
| 2 | `/createApplicationId` | POST | Sync | Initialize app with RBAC, container, and template tables |
...
| **Models** | Request/response schemas defined in [models.py](models.py) |
...
**Source:** [api_main.py#L291](api_main.py#L291)
...
**Purpose:** Initialize a new application with proper RBAC permissions. Creates a blob container, clones template tables, and assigns Storage Blob Data Contributor and Storage Table Data Contributor roles.

**Source:** [api_main.py#L355](api_main.py#L355)
...
```json
{
  ...
  "message": "Application 'myapp-001' setup completed with table-level RBAC. ⚠️ RBAC changes may take up to 10 minutes to propagate."
}
```
...
**Source:** [api_main.py#L550](api_main.py#L550)
...
**Source:** [api_main.py#L650](api_main.py#L650)
...
**Source:** [api_main.py#L737](api_main.py#L737)
...
**Source:** [api_main.py#L824](api_main.py#L824)
...
**Source:** [api_main.py#L911](api_main.py#L911)
...
**Source:** [api_main.py#L996](api_main.py#L996)
...
**Source:** [api_main.py#L1072](api_main.py#L1072)
...
**Source:** [api_main.py#L1926](api_main.py#L1926)
...
**Source:** [api_main.py#L1276](api_main.py#L1276)
...
**Source:** [api_main.py#L1397](api_main.py#L1397)
...
**Headers:** Same as [GET /operations/status](#51-get-operationsstatus) when `app_id` is provided.
...
**Source:** [api_main.py#L1473](api_main.py#L1473)
...
**Source:** [api_main.py#L1604](api_main.py#L1604)
...
**Source:** [api_main.py#L2104](api_main.py#L2104)
...
**Headers:** Required when `app_id` is provided (same as [GET /operations/status](#51-get-operationsstatus)).
...
# Delete old operations globally (no RBAC headers needed)
DELETE /operations/cleanup?confirm=true&days=90
```
