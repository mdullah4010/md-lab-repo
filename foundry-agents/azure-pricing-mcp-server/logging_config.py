...
def _configure_global_logging(level: int) -> None:
    ...
    logging.getLogger('semantic_kernel').setLevel(logging.INFO)
        ...
        # Suppress verbose FastMCP/Docket/Fakeredis debug logging
...
def configure_logging(log_file_name: Optional[str] = None, logger_name: str = "indexer") -> logging.Logger:
    """
    ...
    log_file = log_file_name if log_file_name else os.getenv("LOG_FILE", "indexer.log")
...
def get_logger(module_name: str) -> logging.Logger:
    ...
    :rtype: logging.Logger
    """
    # Read log file name from environment variable, fallback to indexer.log
    log_file = os.getenv("LOG_FILE", "indexer.log")
